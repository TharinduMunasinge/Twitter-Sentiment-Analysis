/**
 * Created by tharindu on 9/21/15.
 */
...
//			double d=x.asDouble();
			...
			String s=re.eval("getwd()").asString();
			System.out.println("load('"+s+"/neural.RData')");
			re.eval("load('"+s+"/neural.RData')");
			re.eval("testdata <- as.data.frame((1:10)^2)");
			re.eval("results <- compute(net.sqrt, testdata)");
			System.out.println(re.eval("results"));

////			System.out.println(re.eval("paste(getwd(),\"model.R\",sep = \"\")",false
////			));
//
//
////			System.out.println(s);
//			System.out.println(re.eval("source('"+s+"')",false
//								));
//
